            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('addmenu.store')}}">Add Menu</a>
                        <a class="collapse-item" href="utilities-border.html">List Menu</a>
                        <a class="collapse-item" href="{{ route('historymenu') }}">History</a>
                        <a class="collapse-item" href="{{ route('menuterjual') }}">Menu Terjual</a>
                        <a class="collapse-item" href="perbandingan.html"> List Menu Terjual</a>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach($perhitunganstoks as $stok)
                                <tr>
