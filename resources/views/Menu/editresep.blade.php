            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <form action="{{ route('menu.update', $menuId) }}" method="POST">
                        ...
                        <!-- Display the existing Nama Menu -->
                        ...
                        <div id="bahan-container">
                            @foreach ($details as $index => $detail)
                                <div class="d-flex mb-3" id="bahan-group-{{ $index }}">
                                    ...
                                    <select id="bahan_id_{{ $index }}" name="bahan_id[]" class="form-control mr-3" required>
                        ...
                        document.getElementById('add-more').addEventListener('click', function() {
                            ...
                            newGroup.innerHTML = `
                                ...
                                <select id="bahan_id_${counter}" name="bahan_id[]" class="form-control mr-3" required>
                                    ...
                                    @foreach ($bahans as $bahan)
                                        <option value="{{ $bahan->id }}">{{ $bahan->bahan_inisiasi->nama_bahan }}</option>
                                    @endforeach
                                </select>
