        ...
        <tbody>
            @foreach($menus as $menu)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('addmenu.edit', $menu->id) }}" class="btn btn-primary">Edit</a>
                        <form action="{{ route('addmenu.destroy', $menu->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
