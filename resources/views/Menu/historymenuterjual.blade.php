...
@if(Auth::user()->role==='admin')
    ...
    @section('main')
    <div class="container">
        <h1>History dari Menu yang Terjual</h1>
        <table class="table">
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                @foreach($menus as $menu)
                    <tr>
                        ...
                        {{-- <td>
                            jika admin maka bisa edit 
                            <a href="{{ route('editbahan', $bahan->id) }}" class="btn btn-primary">Edit</a>
                            <form action="{{ route('deletebahan', $bahan->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('listmenu') }}.html">List Menu</a>
